...
class Products(models.Model):
    ...
    pcategory_code = models.ForeignKey(Category, on_delete=models.CASCADE, verbose_name='상품카테고리 코드')
...
class Also_bought(models.Model):
    p_no = models.ForeignKey(Products, on_delete=models.CASCADE, verbose_name='원상품의 asin')
